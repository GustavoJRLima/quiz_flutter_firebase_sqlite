...
class QuizCiencia extends StatefulWidget {
  const QuizCiencia({super.key});

  @override
  State<QuizCiencia> createState() => _QuizCienciaState();
}

class _QuizCienciaState extends State<QuizCiencia> {
  ...
  Future<void> getQuestions() async {
    questions = await databaseHelper.getQuestionsCiencia();
    setState(() {
      questions = questions;
    });
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(centerTitle: true, title: const Text("Quiz de Ciência")),
      body: Center(
        child:
            questions.isEmpty
                ? Padding(
                      ...
                      ElevatedButton(
                        onPressed: () async {
                          if (nameController.text.isEmpty) {
                            ...
                            await firebaseDbHelper.addScoreCiencia(
                              nameController.text,
                              score,
                            );
