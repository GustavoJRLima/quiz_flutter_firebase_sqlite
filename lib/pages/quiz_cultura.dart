...
class QuizCultura extends StatefulWidget {
  const QuizCultura({super.key});

  @override
  State<QuizCultura> createState() => _QuizCulturaState();
}

class _QuizCulturaState extends State<QuizCultura> {
  ...
  Future<void> getQuestions() async {
    questions = await databaseHelper.getQuestionsCultura();
    setState(() {
      questions = questions;
    });
  }
                      ...
                      ElevatedButton(
                        onPressed: () async {
                          if (nameController.text.isEmpty) {
                            ...
                            await firebaseDbHelper.addScoreCultura(
                              nameController.text,
                              score,
                            );
