...
class QuizConhecimentos extends StatefulWidget {
  const QuizConhecimentos({super.key});

  @override
  State<QuizConhecimentos> createState() => _QuizConhecimentosState();
}

class _QuizConhecimentosState extends State<QuizConhecimentos> {
  ...
  Future<void> getQuestions() async {
    questions = await databaseHelper.getQuestionsConhecimentos();
    setState(() {
      questions = questions;
    });
  }
                      ...
                      ElevatedButton(
                        onPressed: () async {
                          if (nameController.text.isEmpty) {
                            ...
                            await firebaseDbHelper.addScoreConhecimentos(
                              nameController.text,
                              score,
                            );
